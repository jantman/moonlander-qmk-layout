...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    MO(1),          WEBUSB_PAIR,    LALT(KC_LSHIFT),KC_LEFT,        KC_RIGHT,       MT(MOD_LALT, KC_APPLICATION),                                                                                                MT(MOD_LCTL, KC_ESCAPE),KC_UP,          KC_DOWN,        KC_LBRACKET,    KC_RBRACKET,    MO(1),          
    MT(MOD_LSFT, KC_SPACE),KC_BSPACE,      KC_LCTRL,                       KC_LALT,        KC_ENTER,       MT(MOD_RSFT, KC_SPACE)
  ),
  [1] = LAYOUT_moonlander(
